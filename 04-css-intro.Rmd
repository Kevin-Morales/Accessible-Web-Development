...
When we talk about an element's display value, we are reffering to how an element should behave when placed on a web page.
...
Also, make sure to take a break if you need it; there were lots of moving parts in this section, so we recommend that you recharge, so yu can continue to the next section.
