...
Blind persons are capable and full of potential. However, it is imperative that web development tutorials and books are produced in such a way that shows how to put up online portfolios and other websites that showcase their work.
Furthermore, there are many courses and tutorials that teach web development, but they are not as descriptive or as detailed as they could be, and the information is spread out in such a way that forces learners to waste time finding it. This book provides descriptions of what a particular line of code does when using HTML and CSS, so that completely blind persons have a point of reference, in order to develop sites and applications with some level of confidence. Sighted assistance may be needed from time to time, but the goal of this book is to strive for a comfortable level of independence. The promise this book makes to readers is empowerment.
...
* you have an idea you'd like to showcase online;
